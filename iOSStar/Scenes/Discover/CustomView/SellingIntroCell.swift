...
class SellingIntroCell: SellingBaseCell {
    ...
    override func setPanicModel(model: PanicBuyInfoModel?) {
        ...
        backImageView.kf.setImage(with: URL(string:qiniuHelper.shared().qiniuHeader +  model!.back_pic_url), placeholder: nil, options: nil, progressBlock: nil, completionHandler: nil)
